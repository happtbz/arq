...
var DeviceTypesMapeaton = map[string]*DeviceData{
    ...
    "Tripp Lite B064-016-02-IPG": {
        ...
        PowerPorts: []PowerPort{
            { Name: "1", Label: "", Type: "iec-60320-c14", MaximumDraw: 95, AllocatedDraw: 50 },
            { Name: "2", Label: "", Type: "iec-60320-c14", MaximumDraw: 95, AllocatedDraw: 50 },
        },
        PowerOutlets: []PowerOutlet{
        },
        FrontPorts: []FrontPort{
        ...
        Interfaces: []Interface{
            { Name: "1000M Network Adapter 1", Label: "LAN 1", Type: "100base-tx", MgmtOnly: true },
            { Name: "1000M Network Adapter 2", Label: "LAN 2", Type: "100base-tx", MgmtOnly: true },
        },
    },
    "Tripp Lite B064-032-01-IPG": {
        Manufacturer: "Eaton",
        Model: "Tripp Lite B064-032-01-IPG",
        Slug: "eaton-tripp-lite-b064-032-01-ipg",
        UHeight: 1,
        PartNumber: "037332236340",
        IsFullDepth: false,
        Airflow: "",
        FrontImage: true,
        RearImage: true,
        ...
        Interfaces: []Interface{
            { Name: "1000M Network Adapter 1", Label: "LAN 1", Type: "1000base-t", MgmtOnly: true },
            { Name: "1000M Network Adapter 2", Label: "LAN 2", Type: "1000base-t", MgmtOnly: true },
        },
    },
    "Tripp Lite B072-032-IP2": {
        Manufacturer: "Eaton",
        Model: "Tripp Lite B072-032-IP2",
        Slug: "eaton-tripp-lite-b072-032-ip2",
        UHeight: 1,
        PartNumber: "037332177261",
        IsFullDepth: false,
        Airflow: "",
        FrontImage: true,
        RearImage: true,
        ...
        ConsoleServerPorts: []ConsoleServerPort{
            ...
            { Name: "31", Type: "rj-45", Label: "" },
            { Name: "32", Type: "rj-45", Label: "" },
            { Name: "Serial Port 1", Type: "rj-45", Label: "SERIAL 1" },
            { Name: "Serial Port 2", Type: "rj-45", Label: "SERIAL 2" },
        },
        PowerPorts: []PowerPort{
            { Name: "1", Label: "", Type: "iec-60320-c14", MaximumDraw: 65, AllocatedDraw: 50 },
            { Name: "2", Label: "", Type: "iec-60320-c14", MaximumDraw: 65, AllocatedDraw: 50 },
        },
        PowerOutlets: []PowerOutlet{
        },
        FrontPorts: []FrontPort{
        ...
        Interfaces: []Interface{
            { Name: "LAN 1", Label: "", Type: "100base-tx", MgmtOnly: true },
            { Name: "LAN 2", Label: "", Type: "100base-tx", MgmtOnly: true },
        },
    },
    "Tripp Lite B096-016": {
        Manufacturer: "Eaton",
    ...
    "Tripp Lite BP72V15-2U": {
        Manufacturer: "Eaton",
        Model: "Tripp Lite BP72V15-2U",
        Slug: "eaton-tripp-lite-bp72v15-2u",
        UHeight: 2,
        PartNumber: "037332124333",
        IsFullDepth: true,
        Airflow: "front-to-rear",
        FrontImage: false,
        RearImage: false,
    ...
    "Tripp Lite SU3000RTXLCD2U": {
        Manufacturer: "Eaton",
        Model: "Tripp Lite SU3000RTXLCD2U",
        Slug: "eaton-tripp-lite-su3000rtxlcd2u",
        UHeight: 2,
        PartNumber: "037332180100",
        IsFullDepth: true,
        Airflow: "front-to-rear",
        FrontImage: false,
        RearImage: false,
        ...
        PowerPorts: []PowerPort{
            { Name: "Primary", Label: "", Type: "nema-5-30p", MaximumDraw: 2400, AllocatedDraw: 0 },
        },
        PowerOutlets: []PowerOutlet{
            { Name: "1", Type: "nema-5-30r", Label: "", PowerPort: "", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "2", Type: "nema-5-20r", Label: "", PowerPort: "", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "3", Type: "nema-5-20r", Label: "", PowerPort: "", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "4", Type: "nema-5-20r", Label: "", PowerPort: "", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "5", Type: "nema-5-20r", Label: "", PowerPort: "", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "6", Type: "nema-5-15r", Label: "", PowerPort: "", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "7", Type: "nema-5-15r", Label: "", PowerPort: "", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
            { Name: "8", Type: "nema-5-15r", Label: "", PowerPort: "", FeedLeg: "", MaximumDraw: 0, AllocatedDraw: 0 },
    ...
    "Tripp-Lite ISOBAR12ULTRA": {
        Manufacturer: "Eaton",
        Model: "Tripp-Lite ISOBAR12ULTRA",
        Slug: "eaton-tripp-lite-isobar12ultra",
        UHeight: 1,
        PartNumber: "ISOBAR12ULTRA",
        IsFullDepth: false,
        Airflow: "",
        FrontImage: false,
        RearImage: false,
