...
var DeviceTypesMaptp_link = map[string]*DeviceData{
    ...
    "SG2428P": {
        ...
        PowerPorts: []PowerPort{
            { Name: "PS1", Label: "", Type: "iec-60320-c14", MaximumDraw: 301, AllocatedDraw: 0 },
        },
        PowerOutlets: []PowerOutlet{
        },
        FrontPorts: []FrontPort{
    ...
    "T1600G-28PS": {
        Manufacturer: "TP-Link",
        Model: "T1600G-28PS",
        Slug: "tp-link-t1600g-28ps",
        UHeight: 1,
        PartNumber: "T1600G-28PS",
        IsFullDepth: false,
        Airflow: "left-to-right",
        FrontImage: true,
        RearImage: false,
        ...
        PowerPorts: []PowerPort{
            { Name: "PS1", Label: "", Type: "iec-60320-c14", MaximumDraw: 265, AllocatedDraw: 29 },
        },
        PowerOutlets: []PowerOutlet{
        },
        FrontPorts: []FrontPort{
    ...
    "TL-SG3424P": {
        ...
        PowerPorts: []PowerPort{
            { Name: "PS1", Label: "", Type: "iec-60320-c14", MaximumDraw: 358, AllocatedDraw: 0 },
        },
        PowerOutlets: []PowerOutlet{
        },
        FrontPorts: []FrontPort{
    ...
    "TL-SG3428": {
        ...
        Interfaces: []Interface{
            ...
            { Name: "gigabitEthernet 1/0/25", Label: "25", Type: "1000base-x-sfp", MgmtOnly: false },
            { Name: "gigabitEthernet 1/0/26", Label: "26", Type: "1000base-x-sfp", MgmtOnly: false },
            { Name: "gigabitEthernet 1/0/27", Label: "27", Type: "1000base-x-sfp", MgmtOnly: false },
            { Name: "gigabitEthernet 1/0/28", Label: "28", Type: "1000base-x-sfp", MgmtOnly: false },
        },
    },
    "TL-SG3428MP": {
        Manufacturer: "TP-Link",
